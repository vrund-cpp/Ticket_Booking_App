            ...
            child: ListView(
              ...
              children: [
                if (entries.isNotEmpty)
                  _buildSection('Entry Tickets'.tr(), Icons.confirmation_number, [
                ...
                if (parkings.isNotEmpty)
                  _buildSection('Parking'.tr(), Icons.local_parking, [
                ...
                if (attractions.isNotEmpty)
                  _buildSection('Attractions'.tr(), Icons.rocket_launch, [
                ...
                if (movies.isNotEmpty)
                  _buildSection('Movies'.tr(), Icons.movie, [
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final bookingId = await ApiService.createBooking(
                      widget.userId,
                      cart,
                    );
