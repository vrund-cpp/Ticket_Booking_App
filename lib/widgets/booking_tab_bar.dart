...
class BookingTabBar extends StatelessWidget {
  ...
  const BookingTabBar({super.key, required this.activeTab, required this.userId});
      ...
      child: ListView(
              ...
              children: [
                _buildTab(
                  ...
                  onTap: () => context.push('/entry-tickets/booking', extra: userId),
                ),
const SizedBox(width: 12),
                _buildTab(
                  ...
                  onTap: () => context.push('/parking-options/booking', extra: userId),
                ),
                const SizedBox(width: 12),
                _buildTab(
                  context,
                  ...
                  onTap: () => context.push('/attractions/booking', extra: userId),
                ),
                const SizedBox(width: 12),
                _buildTab(
                  context,
